...
void Database_Env::startSql()
{
    ...
    qDebug()<<cur_time;
//    double longitude = qgcApp()->toolbox()->multiVehicleManager()->activeVehicle()->gpsFactGroup()->rawValue
...
//    int pm25 = qgcApp()->toolbox()->multiVehicleManager()->activeVehicle()->gasSensorFactGroup()->pm25().rawValue().toInt();
