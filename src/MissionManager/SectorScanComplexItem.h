...
Q_DECLARE_LOGGING_CATEGORY(SectorScanComplexItemLog)
...
class SectorScanComplexItem : public ComplexMissionItem
{
    Q_OBJECT
...
public:
    ...
    SectorScanComplexItem(Vehicle* vehicle, bool flyView, const QString& kmlOrSHPFile, QObject* parent);

    Q_PROPERTY(CameraCalc*      cameraCalc                  READ cameraCalc                                                 CONSTANT)
    Q_PROPERTY(Fact*            sectorRadius                READ sectorRadius                                               CONSTANT)
    Q_PROPERTY(Fact*            startAngle                  READ startAngle                                                 CONSTANT)
    Q_PROPERTY(Fact*            flyAngle                    READ flyAngle                                                   CONSTANT)
    ...
    Fact* sectorRadius      (void) { return &_sectorRadiusFact; }
    Fact* startAngle        (void) { return &_startAngleFact; }
    Fact* flyAngle          (void) { return &_flyAngleFact; }
    ...
    QString         mapVisualQML        (void) const final { return QStringLiteral("SectorScanMapVisual.qml"); }
    ...
    static const char* sectorRadiusName;
    static const char* startAngleName;
    static const char* flyAngleName;
...
private slots:
    ...
    void _structurePathChanged         (void);
...
private:
    ...
    SettingsFact    _sectorRadiusFact;
    SettingsFact    _startAngleFact;
    SettingsFact    _flyAngleFact;
    ...
    friend class SectorScanComplexItemTest;
};
