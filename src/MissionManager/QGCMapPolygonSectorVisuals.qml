...
Item {
    ...
    property real   _flyAngle:                  45
    property bool   _editCircleRadius:          false
    property bool   _editStartAngle:            false
    property bool   _editFlyAngle:            false
    ...
    function setCircleRadius(center, radius, startAngle, flyAngle) {
        var unboundCenter = center.atDistanceAndAzimuth(0, 0)
        _circleRadius = radius
        var segments = 3
        var angleIncrement = flyAngle / segments
        var angle = startAngle
        mapPolygon.clear()
        mapPolygon.appendVertex(unboundCenter)
...
//        MenuItem {
//            text:           qsTr("起始角度" )
//            onTriggered:    _editStartAngle = true
//        }
//        MenuItem {
//            text:           qsTr("扇形角度" )
//            onTriggered:    _editFlyAngle = true
//        }
    ...
    Component {
        ...
        MissionItemIndicatorDrag {
            ...
            function setRadiusFromDialog() {
                ...
                var startAngle = startAngleField.text
                var flyAngle = flyAngleField.text
                setCircleRadius(mapPolygon.center, radius, startAngle, flyAngle)
                _editCircleRadius = false
                _editStartAngle = false
                _editFlyAngle = false
            }
            ...
            Rectangle {
                ...
                QGCLabel {
                    anchors.right:  startAngleColumn.right
                    anchors.top:    startAngleColumn.top
                    text:           "X"
